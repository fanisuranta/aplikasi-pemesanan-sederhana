...
class _HomePageState extends State<HomePage> {
  ...
  List<MenuItem> menuList = [
    MenuItem(nama: "Jus Buah", harga: 15000, gambar: "assets/jus_buah.jpg"),
    MenuItem(nama: "Mei Lavel", harga: 5000, gambar: "assets/mei_level.jpeg"),
    MenuItem(
        nama: "Nasi Padang", harga: 20000, gambar: "assets/nasi_padang.jpeg"),
  ];
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text("Rp ${menu.harga.toStringAsFixed(0)}",
  ...
  Widget _buildPesananPage() {
    double total =
        keranjang.fold(0, (sum, item) => sum + (item.menu.harga * item.jumlah));
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: Image.asset(item.menu.gambar,
                            width: 50, height: 50),
